...
# model_urls = {
#     'se_resnet50_ibn_a': './logs/pretrained/se_resnet101_ibn_a.pth',
#     'se_resnet101_ibn_a': './logs/pretrained/se_resnet101_ibn_a.pth',
# }
...
def se_resnet50_ibn_a(pretrained=False):
    ...
    if pretrained:
        # state_dict = torch.load(model_urls['se_resnet50_ibn_a'], map_location=torch.device('cpu'))['state_dict']
        # state_dict = remove_module_key(state_dict)
        # model.load_state_dict(state_dict)
        model.load_state_dict(torch.hub.load_state_dict_from_url(model_urls['se_resnet50_ibn_a']))
    return model
...
def se_resnet101_ibn_a(pretrained=False):
    ...
    if pretrained:
        # state_dict = torch.load(model_urls['se_resnet101_ibn_a'], map_location=torch.device('cpu'))['state_dict']
        # state_dict = remove_module_key(state_dict)
        # model.load_state_dict(state_dict)
