...
def init_pretrained_weights(model, key=''):
    ...
    model_dir = os.path.join('logs', 'pretrained')
    try:
    ...
    # state_dict = torch.load(model_urls[key], map_location=torch.device('cpu'))
...
def osnet(pretrained=False, **kwargs):
    """
    ...
    model = OSNet([OSBlock, OSBlock, OSBlock], num_blocks_per_stage, num_channels_per_stage, IN=with_ibn)
